...
def monopoly_with_second_tier
	...
	sets the first key of the :railroads hash to a symbol, :pieces, whose value is the in
teger 4 (FAILED - 1)
	 sets the second key of the :railroads hash to a symbol, :names, whose value is an emp
ty hash (FAILED - 2)
	 sets the third key of the :railroads hash to a symbol, :rent_in_dollars, whose value
is an empty hash (FAILED - 3)
end
